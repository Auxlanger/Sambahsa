...
The author treats Sambahsa as being comprised of *orthographical units* (such as **eau**, **oh** and **uy**), each of which represents one and only one *sound* (such as, respectively, /oː/, /oː/ and /uːi/) but carefully understanding that a *sound* may consist of more than one phoneme.

On each line of the table below, normal Sambahsa spelling of an of *orthographical unit* such as **ai** is shown first in bold green, followed by SPT such as [ä] in square brackets and then IPA such as /ɛ/ between forward slashes. An underscore such as in **ch**_ or \_**y**\_ means 'any consonant.' A question mark such as in **e**? means 'in some positions only.' (To see colour, download README.html.)
...
The sounds that resemble falling diphthongs include: <b>/ʌɪ/ /aʊ/ /eɪ/ /ɔɪ/</b>
...
The units that resemble rising diphthongs include: <b>/wiː/ /je/</b>
...
Other units combining vowels include: <b>/ˈeə/ /uːi/</b>
